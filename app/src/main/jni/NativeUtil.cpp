...
#define LOCI(fmt, args...) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, fmt, ##args)
...
extern "C" {
    ...
    // 获取签名信息
    JNIEXPORT jstring JNICALL Java_com_innotech_demo_utils_NativeUtil_getSignature
...
//        return signature_string;
    ...
    // 检查签名是否被更改过
    JNIEXPORT jboolean JNICALL Java_com_innotech_demo_utils_NativeUtil_checkSignature
            (JNIEnv *env, jclass clazz, jobject context_object) {
        jstring signature = Java_com_innotech_demo_utils_NativeUtil_getSignature(env, clazz, context_object);
    ...
    JNIEXPORT jstring JNICALL Java_com_innotech_demo_utils_NativeUtil_getPrivateKey
            (JNIEnv *env, jclass clazz, jobject context_object) {
        LOCI("-----> : checkSignature  %d", checkSignature);
        if (false == checkSignature) {
            checkSignature = Java_com_innotech_demo_utils_NativeUtil_checkSignature(env, clazz, context_object);
        }
        if (checkSignature) {
